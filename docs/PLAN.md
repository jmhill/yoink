...
**Implementation:**
- One-pile lists use framer-motion `Reorder` (already in `@yoink/web`) with a lucide `GripVertical` handle (`touch-action: none`). Row body keeps swipe-right complete.
