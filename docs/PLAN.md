...
**Yoink UI story 20: Inbox warm triage surface** - Complete ✓ (#98 — costume only: Inbox/Snoozed/Trash share a warm paper pane with large Inbox heading and “N to process · references & triage”; Today/lists stay on the cool task surface; Promote verb, rail, and capture cards unchanged)

Recent updates:
- Yoink UI story 20 “Inbox warm triage surface” (#98): product lock Justin + Polly approved costume frame 2026-09-14. Costume only — Inbox capture pane reads as triage/reference, not a peer of Today. Inbox | Snoozed | Trash share a warm paper / cream pane (not the cool white checklist surface), a large Inbox heading, and subcopy “N to process · references & triage”. Task screens (Today, named lists, Unlisted, smart views) stay on the existing task surface. Capture actions (Promote / Snooze / Trash), count badge, and tabs still work. Promote verb unchanged. Out of scope: #99 capture cards as clippings, #100 rail mode chrome (Capture & triage / Task Family / Lists), Promote rename, Add task, backlinks, vault sync.
