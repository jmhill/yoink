...
**Yoink UI story 20: Inbox warm triage surface** - Complete ✓ (#98 — costume only: Inbox/Snoozed/Trash share a *subtle* warm tint and light Inbox heading + “N to process · references & triage”; Today/lists stay on the cool task surface; warmth is secondary — not a tan wash; Promote verb, rail, and capture cards unchanged)

Recent updates:
- Yoink UI story 20 “Inbox warm triage surface” (#98): product lock Justin + Polly (costume frame 2026-09-14; refinement: warmth is **secondary**). Costume only — Inbox capture pane reads as triage/reference, not a peer of Today. Inbox | Snoozed | Trash share a *subtle* warm tint (not a heavy tan wash / loud rail split) plus a light Inbox heading and subcopy “N to process · references & triage”. Task screens stay on the existing cool/white surface. Capture actions (Promote / Snooze / Trash), count badge, and tabs still work. Promote verb unchanged. Out of scope: #99 capture-card density, #100 rail mode chrome, #101 ⌘K quick capture, Promote rename, Add task, backlinks, vault sync.
