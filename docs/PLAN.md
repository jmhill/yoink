...
**Yoink UI story 25: task-row hybrid chrome** - Complete ✓ (#115 — one-pile named list / Unlisted: complete + title + grip, Edit/Delete behind ⋯; smart views Today / Upcoming / Mine / Done: complete + title + ⋯, no grip; pin stays gone; theme tokens light/dark/tokyo-night; mobile + desktop)

Recent updates:
- Yoink UI story 25 “task-row hybrid chrome” (#115; #116 duplicate): product lock Justin + Polly (2026-09-22). Rows were crowded — grip sat in the same cluster as Edit and Trash. One-pile screens (named list + Unlisted) keep the complete circle and a grip on the right; Edit and Delete move behind ⋯ (no pencil/trash icons next to the grip). Smart views (Today / Upcoming / Mine / Done) have no grip — reorder is already disallowed — and only ⋯ on the right. Complete circle stays; pin chrome stays gone (#111); swipe-to-complete stays; theme tokens in light / dark / tokyo-night. Out of scope: Inbox↔Tasks shell unify, realtime, pin revive, reorder rule changes.
